...
beeCounts <- beeCounts[,c(1:6,13:18,7:12,19:24)]
colnames(beeCounts) <- c(paste0(rep("C",12),".",1:12),paste0(rep("R",12),".",1:12))
beeCounts <- as.matrix(beeCounts)
x <- DGEList(counts=beeCounts)

group <- factor(c(rep("C",12), rep("R",12)))
x$samples$group <- group
lane <- as.factor(c("L12","L12","L12","L12","L34","L34",              "L12","L12","L12","L12","L34","L34","L12","L12","L34","L34","L34","L34","L12","L12","L34","L34","L34","L34"))
x$samples$lane <- lane
```
